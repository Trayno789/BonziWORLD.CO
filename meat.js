...
var videoIds25MinutesofMSAgent = [
  "https://www.youtube.com/watch?v=FhtCeT1Z3R4",
  "https://www.youtube.com/watch?v=8ORUM-du4WM",
  "https://www.youtube.com/watch?v=eS6PyGh_OFI",
  "https://www.youtube.com/watch?v=waTZcR_USfA",
  "https://www.youtube.com/watch?v=5sIFzCOM0Hg",
  "https://www.youtube.com/watch?v=6NqblBxR6oM",
  "https://www.youtube.com/watch?v=QwNdS9SeGvg",
  "https://www.youtube.com/watch?v=0rv24eazu0M",
  "https://www.youtube.com/watch?v=IVCCglOQSr0",
  "https://www.youtube.com/watch?v=elB5Ev396zw",
  "https://www.youtube.com/watch?v=VXxfbEPxhbk",
  "https://www.youtube.com/watch?v=tTxslM61LQQ",
  ...
  "https://www.youtube.com/watch?v=UznclhMfXh0",
  "https://www.youtube.com/watch?v=_ZvXJEow7Hc",
  "https://www.youtube.com/watch?v=_ZvXJEow7Hc",
  ...
  "https://www.youtube.com/watch?v=Inb9uvIYe8I",
  "https://www.youtube.com/watch?v=LcjDvQDMR8s",
  "https://www.youtube.com/watch?v=zEdC45UqX7Y",
  "https://www.youtube.com/watch?v=U6VkGooQxpg",
...
var stickers = {
    ...
    sad: "Aww, how sad!",
    bonzi: "Welcome to the world of BonziBUDDY! He will explore the Internet with you as your very own friend and sidekick!  He can talk, walk, joke, browse, search, e-mail, and download like no other friend you've ever had!",
    host: "Host is my brother!!!!!",
    spook: "oooooooo im spook",
    ...
    kiddie: "Kiddi- wait no this is removed? God fuuuuuuuuck!",
...
let userCommands = {
    godmode: function (word) {
		let success = word == this.room.prefs.godword;
			if (success) {
				...
				this.socket.emit("alert", `Wrong password. Did you try "Password"? Or yo've got blocked by an admin.`);
			}
	...
	behh: function () {
		this.room.emit("talk", {
			text: "Well. That was all good, but, you want more? Well don't worry, I have plenty of business proposals though, I have one tailor specifically to your needs. See this mask? I just want you to clean it real quick so I can explain what proposal well... DIE!",
			guid: this.guid
		})
	},
    "fact": function() {
    ...
    wtf: function (text) {
        var wtf = [
          ...
          "i keep watching the potty song like forever now",
    ...
    ban: function (data) {
        ...
        if (pu && pu.color) {
            ...
            this.socket.emit("alert", "The user you are trying to ban left. Shame it!");
        }
    },*/
	"unban": function(ip) {
        if (this.private.runlevel < 3) {
    ...
    obama: async function (args) {
        ...
        try {
            ...
            this.socket.emit("talk", {
                guid: this.guid,
                text: "<small>Only you can see this.</small><br>N ooooooooooooooooo Command failed! Probably an issue with your input.",
...
class User {
  ...
  async updatebonzitv() {
    ...
    talk(data) {
		...
		if (!/^[~`!@#$%^&*()_+=\w[\]\\{}|;':",.\//<>?\s\w&.\-б]*$/i.test(text) || !/^[~`!@#$%^&*()_+=\w[\]\\{}|;':",.\//<>?\s\w&.\-б]*$/i.test(text)) {
